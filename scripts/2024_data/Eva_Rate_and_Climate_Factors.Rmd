...
Before running the code, I defined some global settings and load necessary libraries. You don't need to change the settings but please make sure you have all the libraries downloaded to your computer.
...
However, you will need to change the working directory to your own personal computer's directory when you download it. 
...
In order to simplify main code body, several functions are defined below
...
First, we will load the water level data from the evaporation pan and precipitation data from precipitation gauge. We will first just plot the water level data over time to get an overview of how it changes with time.
...
Here, we just simply importing all the climate factor data from all the gauges and plot them with time. Data are up to date with the latest download.
...
We plot the evaporation rate against other climate factors to examine the relationship between them.
