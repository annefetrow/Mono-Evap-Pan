...
This is an assisting function that ensures two tables having the same size.
...
This part of the code calculates the conversion coefficient and converted the pan evaporation rate to estimate over lake evaporation.
